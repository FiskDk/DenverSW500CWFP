Public Class Step2
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If ImgSelected = True Then
            If IO.File.Exists(appPath & "\Workspace\clockbackground0.png") Then
                IO.File.Delete(appPath & "\Workspace\clockbackground0.png")
            End If
            RectangleShape3.BackgroundImage.Save(appPath & "\Workspace\clockbackground0.png")
            Step3.Show()
            Me.Close()
        Else
