Public Class Step3
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If ImgSelected = True Then
            If IO.File.Exists(appPath & "\Workspace\clockhour0.png") Then
                IO.File.Delete(appPath & "\Workspace\clockhour0.png")
            End If
            RectangleShape3.BackgroundImage.Save(appPath & "\Workspace\clockhour0.png")
                Me.Close()
                Step4.Show()
            Else
