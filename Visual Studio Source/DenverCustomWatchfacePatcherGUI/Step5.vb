Public Class Step5
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If ImgSelected = True Then
            If IO.File.Exists(appPath & "\Workspace\clocksecond0.png") Then
                IO.File.Delete(appPath & "\Workspace\clocksecond0.png")
            End If
            RectangleShape3.BackgroundImage.Save(appPath & "\Workspace\clocksecond0.png")
            Me.Close()
            Progress.Show()
        Else
